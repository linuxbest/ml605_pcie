...
#vlog -incr -work k7_tlp_v1_00_a "../../k7aes_sim/*.v" {+incdir+../../pciebfm_lib/}

vlog -incr -work work           "../../k7aes_sim/*.v" {+incdir+../../pciebfm_lib/}
vlog -incr -work work            ../../k7aes_sim/rp/*.v

vlog -incr -work work "k7sim_gt_tb.v" {+incdir+../../pciebfm_lib/}
