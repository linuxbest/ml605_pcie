...
module altpcie_stub (/*AUTOARG*/
   ...
   reg [11:0] rx_fc_cpld_ava;
   reg [7:0]  rx_fc_cplh_ava;
   reg [11:0] rx_fc_npd_ava;
   reg [7:0]  rx_fc_nph_ava;
   reg [11:0] rx_fc_pd_ava;
   reg [7:0]  rx_fc_ph_ava;

   reg [11:0] rx_fc_cpld_lmt;
   reg [7:0]  rx_fc_cplh_lmt;
   reg [11:0] rx_fc_npd_lmt;
   reg [7:0]  rx_fc_nph_lmt;
   reg [11:0] rx_fc_pd_lmt;
   reg [7:0]  rx_fc_ph_lmt;

   reg [11:0] rx_fc_cpld_con;
   reg [7:0]  rx_fc_cplh_con;
   reg [11:0] rx_fc_npd_con;
   reg [7:0]  rx_fc_nph_con;
   reg [11:0] rx_fc_pd_con;
   reg [7:0]  rx_fc_ph_con;

   reg [11:0] tx_fc_cpld_ava;
   reg [7:0]  tx_fc_cplh_ava;
   reg [11:0] tx_fc_npd_ava;
   reg [7:0]  tx_fc_nph_ava;
   reg [11:0] tx_fc_pd_ava;
   reg [7:0]  tx_fc_ph_ava;

   reg [11:0] tx_fc_cpld_lmt;
   reg [7:0]  tx_fc_cplh_lmt;
   reg [11:0] tx_fc_npd_lmt;
   reg [7:0]  tx_fc_nph_lmt;
   reg [11:0] tx_fc_pd_lmt;
   reg [7:0]  tx_fc_ph_lmt;

   reg [11:0] tx_fc_cpld_con;
   reg [7:0]  tx_fc_cplh_con;
   reg [11:0] tx_fc_npd_con;
   reg [7:0]  tx_fc_nph_con;
   reg [11:0] tx_fc_pd_con;
   reg [7:0]  tx_fc_ph_con;
   ...
   always @(posedge user_clk)
	...
	case (fc_sel2)
	  3'b000: begin 
	     ...
	     rx_fc_npd_ava  <= #1 fc_npd;
	     rx_fc_nph_ava  <= #1 fc_nph;
	     rx_fc_pd_ava   <= #1 fc_pd;
	     rx_fc_ph_ava   <= #1 fc_ph;
	  end
	  3'b001: begin 
	     rx_fc_cpld_lmt <= #1 fc_cpld;
	     rx_fc_cplh_lmt <= #1 fc_cplh;
	     rx_fc_npd_lmt  <= #1 fc_npd;
	     rx_fc_nph_lmt  <= #1 fc_nph;
	     rx_fc_pd_lmt   <= #1 fc_pd;
	     rx_fc_ph_lmt   <= #1 fc_ph;
	  end
	  3'b010: begin 
	     rx_fc_cpld_con <= #1 fc_cpld;
	     rx_fc_cplh_con <= #1 fc_cplh;
	     rx_fc_npd_con  <= #1 fc_npd;
	     rx_fc_nph_con  <= #1 fc_nph;
	     rx_fc_pd_con   <= #1 fc_pd;
	     rx_fc_ph_con   <= #1 fc_ph;
	  end
	  3'b100: begin 
	     tx_fc_cpld_ava <= #1 fc_cpld;
	     tx_fc_cplh_ava <= #1 fc_cplh;
	     tx_fc_npd_ava  <= #1 fc_npd;
	     tx_fc_nph_ava  <= #1 fc_nph;
	     tx_fc_pd_ava   <= #1 fc_pd;
	     tx_fc_ph_ava   <= #1 fc_ph;
	  end
	  3'b101: begin 
	     tx_fc_cpld_lmt <= #1 fc_cpld;
	     tx_fc_cplh_lmt <= #1 fc_cplh;
	     tx_fc_npd_lmt  <= #1 fc_npd;
	     tx_fc_nph_lmt  <= #1 fc_nph;
	     tx_fc_pd_lmt   <= #1 fc_pd;
	     tx_fc_ph_lmt   <= #1 fc_ph;
	  end
	  3'b110: begin 
	     tx_fc_cpld_con <= #1 fc_cpld;
	     tx_fc_cplh_con <= #1 fc_cplh;
	     tx_fc_npd_con  <= #1 fc_npd;
	     tx_fc_nph_con  <= #1 fc_nph;
	     tx_fc_pd_con   <= #1 fc_pd;
	     tx_fc_ph_con   <= #1 fc_ph;
	  end	  	  
	endcase
     end
